...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser("yarn-recipe")
    ...
    parser = _add_yarn_args(parser=parser)
...
def _add_yarn_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    group = parser.add_argument_group(title='yarn')

    group.add_argument("--scaling-factor", type=float, default=16.0)
    group.add_argument("--scaling-type", type=str, default="yarn")
    group.add_argument("--rope-theta", type=float, default=10000.0)
    group.add_argument("--architecture", type=str,
                      choices=["llama", "mistral"], default="llama")
    group.add_argument("--max-position-embeddings", type=int)
    group.add_argument("--sliding-window-attention-schedule", type=str)
    group.add_argument("--original-max-position-embeddings", type=int)
